...
import { UserPlus, User, Shield, Info } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const errorMsg = await register(name, email, password, role);
    if (!errorMsg) {
      if (role === 'student') {
      ...
      <div className="auth-card" style={{
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '14.5px', margin: 0 }}>
            Join Campus Voice to report and track campus issues
          </p>
        </div>
